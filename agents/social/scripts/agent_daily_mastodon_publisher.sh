  ...
  while [[ $# -gt 0 ]]; do
    case "$1" in
      ...
      --help|-h)
        cat <<'EOF'
Usage:
  ./agents/social/scripts/agent_daily_mastodon_publisher.sh
  ./agents/social/scripts/agent_daily_mastodon_publisher.sh --date 2026-03-18
  ./agents/social/scripts/agent_daily_mastodon_publisher.sh --date 2026-03-18 --archive-key 2026-03-18-1
  ./agents/social/scripts/agent_daily_mastodon_publisher.sh --date 2026-04-01 --date-root previous-article-posts
  ./agents/social/scripts/agent_daily_mastodon_publisher.sh --dry-run
...
main() {
  ...
  local -a cmd=(node "$AGENTS_REPO_DIR/agents/social/scripts/publish-daily-mastodon.js")
