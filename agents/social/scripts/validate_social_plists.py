...
SOCIAL_PLIST_DIR = REPO_ROOT / "agents" / "social" / "deploy" / "launchd"
SALES_PLIST_DIR = REPO_ROOT / "agents" / "sales" / "deploy" / "launchd"
RUNNER_PLIST_DIR = REPO_ROOT / "agents" / "product" / "code" / "deploy" / "launchd"
