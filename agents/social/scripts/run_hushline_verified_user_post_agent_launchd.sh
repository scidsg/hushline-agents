...
Usage:
  ...
  ./agents/social/scripts/run_hushline_verified_user_post_agent_launchd.sh --date 2026-06-10
...
plan_post() {
  "$AGENTS_REPO_DIR/agents/social/scripts/run_verified_user_weekly_launchd.sh" --date "$(effective_date)"
}
