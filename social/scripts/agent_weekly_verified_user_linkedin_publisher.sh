  ...
  while [[ $# -gt 0 ]]; do
    case "$1" in
      ...
      --help|-h)
        cat <<'EOF'
Usage:
  ./social/scripts/agent_weekly_verified_user_linkedin_publisher.sh
  ./social/scripts/agent_weekly_verified_user_linkedin_publisher.sh --date 2026-03-30
  ./social/scripts/agent_weekly_verified_user_linkedin_publisher.sh --dry-run
