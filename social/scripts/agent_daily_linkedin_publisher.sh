  ...
  while [[ $# -gt 0 ]]; do
    case "$1" in
      ...
      --help|-h)
        cat <<'EOF'
Usage:
  ./social/scripts/agent_daily_linkedin_publisher.sh
  ./social/scripts/agent_daily_linkedin_publisher.sh --date 2026-03-18
  ./social/scripts/agent_daily_linkedin_publisher.sh --date 2026-03-18 --archive-key 2026-03-18-1
  ./social/scripts/agent_daily_linkedin_publisher.sh --date 2026-04-01 --date-root previous-article-posts
  ./social/scripts/agent_daily_linkedin_publisher.sh --dry-run
