...
lint: ## Check Python formatting, lint, typing, and shell syntax
	...
	for script in agents/product/code/scripts/*.sh agents/product/code/scripts/lib/*.sh agents/social/scripts/*.sh agents/social/scripts/lib/*.sh agents/sales/scripts/*.sh; do bash -n "$$script"; done
